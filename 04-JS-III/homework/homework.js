...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
	a=0;
	for (i=0;i<resultadosTest.length;i=i+1){
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
	var igual = (currentValue) => currentValue === arreglo[0];
	return arreglo.every(igual);
} 
